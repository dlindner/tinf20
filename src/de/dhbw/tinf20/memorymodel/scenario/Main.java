package de.dhbw.tinf20.memorymodel.scenario;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		//System.out.println(Scenario.runFor((int) 9E5, Scenario3::new));
		//System.out.println(Scenario.runFor((int) 1E5, Scenario4::new));
		System.out.println(Scenario.runFor((int) 9E6, Scenario5::new));
	}
}
